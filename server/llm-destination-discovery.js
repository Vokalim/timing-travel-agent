...
const regions={Beijing:'China',Shanghai:'China',Chengdu:'China',Chongqing:'China',Changsha:'China',Xiamen:'China',Sanya:'China',Kunming:'China',Dali:'China',Lijiang:'China',Guilin:'China',"Xi'an":'China',Hangzhou:'China',Nanjing:'China',Qingdao:'China',Harbin:'China',Guangzhou:'China',Shenzhen:'China','Hong Kong':'Hong Kong SAR',Tokyo:'Japan',Osaka:'Japan',Seoul:'South Korea',Singapore:'Singapore',Bangkok:'Thailand',London:'United Kingdom',Paris:'France'};
...
export class LLMDestinationDiscoveryService {
  ...
  async discover(preferences,context={}) {
    ...
    const instructions=`Propose 5 to 8 real destination cities for travel discovery. Choose only from Beijing (BJS), Shanghai (SHA), Chengdu (CTU), Chongqing (CKG), Changsha (CSX), Xiamen (XMN), Sanya (SYX), Kunming (KMG), Dali (DLU), Lijiang (LJG), Guilin (KWL), Xi'an (XIY), Hangzhou (HGH), Nanjing (NKG), Qingdao (TAO), Harbin (HRB), Guangzhou (CAN), Shenzhen (SZX), Hong Kong (HKG), Tokyo (TYO), Osaka (OSA), Seoul (SEL), Singapore (SIN), Bangkok (BKK), London (LON), and Paris (PAR), excluding the origin city. Respect geographyPreference: domestic means mainland China, international means outside mainland China, all should include both where sensible. Return suggestions and qualitative reasons only. Never provide flight or hotel prices, availability, popularity rankings, or numeric recommendation scores. Explicit travelIntents outrank inferredTemporalIntents. A general popularity prior may only be described as generally popular; never claim currently trending. Keep geography and trip duration practical. Write reasons in the requested language.`;
